...
export default async function Home() {
    ...
    return (
        <div className="max-w-[1200px] gap-10 grid grid-cols-12">
            <Card isFooterBlurred className="w-full h-[250px] col-span-12 sm:col-span-12">
            ...
            <Card className="col-span-6 sm:col-span-4 h-[250px]">
                <Link href="/tracking" color="primary">
                    <CardHeader className="absolute z-10 top-1 flex-col !items-start">
                        <p className="text-tiny uppercase font-bold">Tracking</p>
